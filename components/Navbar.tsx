...
const NAV_ITEMS = [
    ...
    },
    {
        ...
        children: [
            ...
            { label: "Rotate PDF", href: "#", icon: IconRotate },
            { label: "Crop PDF", href: "#", icon: IconCrop },
            { label: "Organise Pages", href: "#", icon: IconStack },
            { label: "Remove Pages", href: "#", icon: IconFileX },
            { label: "Page Numbers", href: "#", icon: IconNumbers },
        ],
    },
    {
        label: "Optimise",
        href: "#optimise",
        children: [
            { label: "Compress PDF", href: "#", icon: IconLayersSubtract },
            { label: "Repair PDF", href: "#", icon: IconFileCheck },
    ...
    },
    {
        ...
        children: [
            ...
            { label: "Sign PDF", href: "#", icon: IconWriting },
            { label: "Watermark", href: "#", icon: IconDroplet },
            { label: "Redact PDF", href: "#", icon: IconEraser },
    ...
    },
    {
        ...
        href: "#security",
        children: [
            { label: "Protect PDF", href: "#", icon: IconLock },
            { label: "Unlock PDF", href: "#", icon: IconLockOpen },
        ],
    },
    {
        label: "All Tools",
