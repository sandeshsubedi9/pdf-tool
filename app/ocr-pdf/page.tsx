    ...
    const descriptionContent = (
        <div className="flex flex-col gap-5 mt-4">
            <p className="text-brand-sage leading-relaxed">
                Turn static scans into searchable, editable documents with SandeshPDF’s OCR PDF tool. Our Optical Character Recognition (OCR) technology recognizes text in images, allowing you to edit scanned PDFs and copy content instantly.
            </p>
