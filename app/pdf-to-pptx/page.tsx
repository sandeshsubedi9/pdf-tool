    ...
    const descriptionContent = (
        <div className="flex flex-col gap-5 mt-4">
            <p className="text-brand-sage leading-relaxed">
                Revitalize your presentations with PDF Maya’s PDF to PowerPoint tool. Convert static PDF slides into editable PPTX files, allowing you to update content, add animations, and customize designs.
            </p>
